# main_api.py
# Ponto de entrada do Script 2 — API
...
from infrastructure.api_client import coletar_via_api
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("  INICIANDO SCRIPT 2 — API")
    logger.info("=" * 50)

    caminho_csv = None

    try:
        # ─── Etapa 1: Coleta via API com Retry ───────────────────────────
        logger.info("Etapa 1/3 — Coletando cotações via API...")
        ...
        enviar_email(
            assunto="Script API — Cotações BTime",
